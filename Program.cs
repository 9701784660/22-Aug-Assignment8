...
namespace Assignment8
{
        ...
        internal class Program
        {
            ...
            public static void DeleteProductRecord()
            {
                ...
                Product productToDelete = db.Products.FirstOrDefault(p => p.PtroductId == productId);
            ...
            public static void UpdateProductRecord()
            {
                ...
                Product productToUpdate = db.Products.FirstOrDefault(p => p.PtroductId == productId);
            ...
            public static void DisplayProductRecords()
            {
                ...
                {
                    Console.WriteLine("Product ID: " + prod.PtroductId);
